...
<Tabs items={['default', 'const']}>
    ...
    <Tabs.Tab>
        ...
        ```typescript
        import {
            SwppConfigCompilationEnv, SwppConfigCrossEnv, SwppConfigRuntimeDep,
            SwppConfigCrossDep, SwppConfigRuntimeCore, SwppConfigRuntimeEvent,
            SwppConfigDomConfig, SwppConfigModifier
        } from 'swpp-backends/dist/swpp/config/ConfigCluster'

        export const compilationEnv: SwppConfigCompilationEnv = {}

        export const crossEnv: SwppConfigCrossEnv = {}

        export const runtimeDep: SwppConfigRuntimeDep = {}

        export const crossDep: SwppConfigCrossDep = {}

        export const runtimeCore: SwppConfigRuntimeCore = {}

        export const runtimeEvent: SwppConfigRuntimeEvent = {}

        export const domConfig: SwppConfigDomConfig = {}
